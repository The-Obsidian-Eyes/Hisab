...
Future<void> showEditSale(BuildContext context, Entry sale) async {
  final notes = TextEditingController(text: sale.notes);
  final amount = TextEditingController(text: sale.amount.toString());
